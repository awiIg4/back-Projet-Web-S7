...
// Route d'inscription pour les vendeurs
...
// Route de connexion pour les vendeurs
router.post('/login', async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    ...
    if (!utilisateur || utilisateur.typeUtilisateur !== 'vendeur') {
    ...
    res.cookie('refreshToken', refreshToken, {
      ...
      secure: process.env.NODE_ENV === 'production',
      sameSite: 'lax',
      path: '/api/vendeurs/refresh-token',
    });
...
// Route pour récupérer les informations du vendeur connecté
