...
let Utilisateur = class Utilisateur extends sequelize_typescript_1.Model {
};
__decorate([
...
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, allowNull: false }),
    __metadata("design:type", String)
], Utilisateur.prototype, "type_utilisateur", void 0);
Utilisateur = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: 'utilisateurs', timestamps: false })
], Utilisateur);
