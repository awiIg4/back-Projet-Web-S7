...
let Acheteur = (() => {
    ...
    var Acheteur = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
            this.id = __runInitializers(this, _id_initializers, void 0);
            this.achats = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _achats_initializers, void 0));
            __runInitializers(this, _achats_extraInitializers);
        }
    };
    __setFunctionName(_classThis, "Acheteur");
    (() => {
        ...
        Acheteur = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Acheteur = _classThis;
})();
exports.default = Acheteur;
